...
import wallsImg from "../assets/tiles/walls.png";
import floorsImg from "../assets/tiles/floors.png";
import test_level_tilemap from "../assets/tiles/tilemap.json";
...
export default class LoadingScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("floors", floorsImg);
    this.load.tilemapTiledJSON('test_level', test_level_tilemap)
